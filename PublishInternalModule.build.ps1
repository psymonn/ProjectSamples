...
task Test BeforeTest, RunTests, AfterTest, Publish
...
task . initPreference, UpdateBuildManifest, Dependencies, Clean, Test, Publish
...
task SaveDependency {
    ...
    $moduleInfo = @{
        ...
        SaveRepoName    = $Settings.SaveRepoName
        Artifacts       = $Artifacts
        config          = $config
