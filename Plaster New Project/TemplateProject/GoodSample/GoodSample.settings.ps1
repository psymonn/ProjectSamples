...
param(
    $Artifacts = './artifacts',
	$ModuleName = "GoodSample",
	$ModulePath = './GoodSample',
...
$Settings = @{
	...
	Tags = ""
    Author = 'psymonn'
    LicenseUrl = 'https://github.com/psymonn/GoodSample/LICENSE'
    ProjectUrl = "https://github.com/psymonn/GoodSample"
    PackageDescription = 'asdf'
    Repository = 'https://github.com/psymonn/GoodSample.git'
    # TODO: fix any redudant naming
    GitRepo = "psymonn/GoodSample"
    CIUrl = "http://localhost:8080/job/GoodSample Pineline/"
}
