...
param(
    $Artifacts = './artifacts',
	$ModuleName = "GoodSample7",
	$ModulePath = './GoodSample7',
...
$Settings = @{
    ...
    Author = 'psymonn'
	 Owners = 'A Team'
    LicenseUrl = 'https://github.com/psymonn/GoodSample7/LICENSE'
    ProjectUrl = "https://github.com/psymonn/GoodSample7"
    PackageDescription = 'test'
    Repository = 'https://github.com/psymonn/GoodSample7.git'
    # TODO: fix any redudant naming
    GitRepo = "psymonn/GoodSample7"
    CIUrl = "http://localhost:8080/job/GoodSample7 Pineline/"
}
