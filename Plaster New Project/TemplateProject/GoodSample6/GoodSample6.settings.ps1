...
param(
    $Artifacts = './artifacts',
	$ModuleName = "GoodSample6",
	$ModulePath = './GoodSample6',
...
$Settings = @{
    ...
    Author = 'psymonn'
	 Owners = 'A Team'
    LicenseUrl = 'https://github.com/psymonn/GoodSample6/LICENSE'
    ProjectUrl = "https://github.com/psymonn/GoodSample6"
    PackageDescription = 'sads'
    Repository = 'https://github.com/psymonn/GoodSample6.git'
    # TODO: fix any redudant naming
    GitRepo = "psymonn/GoodSample6"
    CIUrl = "http://localhost:8080/job/GoodSample6 Pineline/"
}
