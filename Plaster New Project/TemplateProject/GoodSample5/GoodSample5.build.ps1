# Include: Settings
. './GoodSample5.settings.ps1'
# Include: build_utils
. './build_utils.ps1'

Update-ModuleManifest -Path .\GoodSample5\GoodSample5.psd1 -ModuleVersion "1.1.1.0"
...
task Clean BeforeClean, {
    ...
    # Temp
    #If let it run then error -> fatal: destination path 'GoodSample5' already exists and is not an empty directory.
	#& git clone https://github.com/psymonn/GoodSample5.git	
