...
param(
    $Artifacts = './artifacts',
	$ModuleName = "GoodSample5",
	$ModulePath = './GoodSample5',
...
$Settings = @{
    ...
    Author = 'psymonn'
	 Owners = 'A Team'
    LicenseUrl = 'https://github.com/psymonn/GoodSample5/LICENSE'
    ProjectUrl = "https://github.com/psymonn/GoodSample5"
    PackageDescription = 'sdaf'
    Repository = 'https://github.com/psymonn/GoodSample5.git'
    # TODO: fix any redudant naming
    GitRepo = "psymonn/GoodSample5"
    CIUrl = "http://localhost:8080/job/GoodSample5 Pineline/"
}
