# Run this in an administrative PowerShell prompt to install the newCleanModule PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://www.github/Psymon/newCleanModule/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'newCleanModule'
$DownloadURL = 'https://www.github/Psymon/newCleanModule/raw/master/release/newCleanModule-current.zip'
