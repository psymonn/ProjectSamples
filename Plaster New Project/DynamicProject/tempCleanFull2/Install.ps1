# Run this in an administrative PowerShell prompt to install the tempCleanFull2 PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://www.github.com/psymon/tempCleanFull2/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'tempCleanFull2'
$DownloadURL = 'https://www.github.com/psymon/tempCleanFull2/raw/master/release/tempCleanFull2-current.zip'
