...
if ((Get-Variable 'BuildEnv' -ErrorAction:SilentlyContinue) -eq $null) {
    $Script:BuildEnv = New-Object -TypeName PSObject -Property @{
        ...
        Encoding = 'utf8'
        ModuleToBuild = 'tempCleanFull2'
        ModuleVersion = '0.0.1'
        ModuleWebsite = 'https://www.github.com/psymon/tempCleanFull2'
        ModuleCopyright = "(c) $((get-date).Year.ToString()) Psymon. All rights reserved."
        ModuleLicenseURI = 'https://www.github.com/psymon/tempCleanFull2/LICENSE.md'
        ModuleTags = 'tmepCleanFull2Tag' -split ','
        ModuleAuthor = 'Psymon'
        ModuleDescription = 'Temp Clean Full 2 Module'
        ...
        # You should NOT enter this key here but rather manually enter it in the tempCleanFull2.buildenvironment.json file with: set-buildenvironment -NugetAPIKey '<key>'
    ...
    ########################################
    $PersistentBuildFile = join-path $PSScriptRoot "tempCleanFull2.buildenvironment.json"
